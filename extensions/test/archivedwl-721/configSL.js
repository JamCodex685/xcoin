...
config.tradingAdvisor = {
  enabled: true,
  method: 'MoonShotAllStarsSL',
  fastAdviceEmit: true,
  candleSize: 1,
  historySize: 60,
}

// MoonShotAllStars settings:
config.MoonShotAllStarsSL = {
	ADX: {
	optInTimePeriod: 14
},
	MACD: {
    ...
    optInSlowDPeriod: 3,
	optInSlowD_Period: 3,
	optInSlowK_MAType: 2, // using EMA for Ta-Lib
	optInSlowD_MAType: 2 // using EMA for Ta-Lib
 },
  thresholds: {
 //   trend: 'long',
	low: 33.33,
...
config.postgresql = {
  ...
  database: 'gekkodev', // if set, we'll put all tables into a single database.
  schema: 'public',
  dependencies: [{
    module: 'pg',
    version: '7.4.3'
